...
function resetAll() {
    activePosition = blankBoard;
    whiteInfluence = blankBoard;
    blackInfluence = blankBoard;
    moveHistory = [];
    calculatedLines = [];
}
...
function clearSettings() {
    whiteInfluence = blankBoard;
    blackInfluence = blankBoard;
    // let moveMainCalculatedLine = [];
    calculatedLines = [];
    // calculatedLines = calculatedLines.push(moveMainCalculatedLine)
}
