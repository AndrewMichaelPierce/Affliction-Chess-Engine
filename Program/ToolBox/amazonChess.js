    ...
    checkmate: {
        ...
        calc: function () {
            ...
            if (gameRules.check.inCheck === true && gameRules.checkmate.flightSquaresAttacked === black.king.influence.length) {
                ...
                chessboard.blackInfluence[black.king.location] = " X";
    ...
    stalemate: {
        calc: function () {
            if (gameRules.check.inCheck === false && gameRules.checkmate.flightSquaresAttacked === black.king.influence.length) {
                ...
                chessboard.blackInfluence[black.king.location] = " V";
            }
        },
        isStalemate: false,
        sum: 0
    ...
    safe: {
        calc: function () {
            if (gameRules.check.inCheck === false && gameRules.stalemate.isStalemate === false) {
                gameRules.safe.sum++;
                chessboard.blackInfluence[black.king.location] = " S";
            }
        },
        sum: 0
    },
...
let kata = {
    moveBlackKing: function () {
        if (chessboard.active[black.king.location] === 200 && black.king.location < 99) {
            black.king.location++;
            gameRules.occupied();
            gameRules.legal();
            gameRules.kingZone();
        ...
        if (chessboard.active[black.king.location] === chessboard.blank[black.king.location]) {
            chessboard.active[black.king.location] = black.king.piece;
        }
    },
    ...
    kingEvaluation: function (king, amazon) {
        ...
        do {
            ...
            chessboard.blackInfluence[white.amazon.location] = " A";
            kata.placePiece(king, "king");
            chessboard.blackInfluence[white.king.location] = " K";
    ...
    reset: function () {
        ...
        //chessboard.blackInfluence = chessboard.blank.slice(0);
    ...
    result: function() {
        ...
        for (let i = 0; i < 100; i += 10) {
            console.log(chessboard.blackInfluence.slice((10 + i),(20 + i)) + "\n");
        }
        console.log(result);
        return result;
    },
